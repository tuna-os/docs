...
export const VARIANTS: Variant[] = [
  ...
  },
  {
    ...
    features: [BOOTC, {
      ...
      text: 'openSUSE Tumbleweed with zypper — rolling, atomic — rolling release, latest packages, now on bootc.',
    }],
    flavors: [
  ...
  },
  {
    ...
    lede: 'Gentoo on bootc with emerge. Source-based, every package compiled with your USE flags — every package compiled with your USE flags. Experimental, hours-long builds, unparalleled flexibility.',
    accent: '#54487a',
    accent2: '#7c3aed',
    stats: [
    ...
    features: [BOOTC, {
      ...
      text: 'emerge compiles everything with your USE flags — ultimate customization on an immutable bootc base.',
    }],
    flavors: [
