...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    features: [
      {emoji: '🧱', title: 'Everything from source', text: 'Qt 6, KDE Frameworks, Plasma, and apps — ~170 BuildStream elements, no binary packages. If it ships, we built it.'},
      ...
      {emoji: '🧩', title: 'Two-repo architecture', text: 'kde-build-meta handles the KDE base (the Plasma stack); Tromsø layers Aurora theming, defaults, and the bootc shim on top. Change one without rebuilding the other.'},
    ],
    install: [
