...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    slug: '/docs/chunkah',
    icon: '📦',
    description: 'OCI layer tool that reassembles container images with content-based layers for faster pulls and efficient distribution.',
    status: 'experimental',
    links: [
      {label: 'Documentation', to: '/docs/chunkah'},
      {label: 'GitHub', to: 'https://github.com/tuna-os/chunkah'},
    ],
  },
  {
