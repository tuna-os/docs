  ...
  tutorialSidebar: [
    {
      ...
      collapsed: false,
      items: ['intro', 'installation', 'installer', 'system-requirements', 'bootc-resources', 'faq', 'ublue-ecosystem'],
    },
    {
      type: 'category',
      label: '🐟 Variants',
    ...
    },
    {
      ...
      items: [
        ...
        'tunaos/SECURITY',
        {
          ...
          collapsible: true,
          collapsed: true,
          items: ['tunaos/introduction', 'tunaos/building', 'tunaos/ai-ml-development', 'tunaos/bootc-usage', 'tunaos/cosmic-desktop', 'tunaos/homebrew', 'tunaos/platform-engineering', 'tunaos/live-iso-generation', 'tunaos/installer-walkthrough', 'tunaos/ci-cd', 'tunaos/troubleshooting'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'iso-builder/index', label: 'ISO Builder'},
