...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    {type: 'category', label: '🏢 Office Suite', link: {type: 'doc', id: 'gtk-office-suite/index'}, items: [
      {type: 'doc', id: 'tables/index', label: '📊 Tables'},
      {type: 'doc', id: 'decks/index', label: '📽️ Decks'},
      {type: 'doc', id: 'letters/index', label: '📝 Letters'},
    ]},
