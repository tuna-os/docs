...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    {type: 'category', label: 'Tacklebox', link: {type: 'doc', id: 'tacklebox/index'}, items: ['tacklebox/ARCHITECTURE', 'tacklebox/getting-started', 'tacklebox/github-iso-setup', 'tacklebox/TODO']},
