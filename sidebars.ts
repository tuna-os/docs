  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        'tunaos/SECURITY',
        {
          ...
          collapsible: true,
          collapsed: true,
          items: ['tunaos/introduction', 'tunaos/building', 'tunaos/live-iso-generation', 'tunaos/ci-cd', 'tunaos/troubleshooting'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'category', label: 'COPR Builds', link: {type: 'doc', id: 'copr/index'}, items: ['copr/ARCHITECTURE', 'copr/gnome49-centos-bootc', 'copr/gnome50-guide']},
      ],
    },
    {
      type: 'category',
