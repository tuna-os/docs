...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    'bootc-resources',
    {type: 'category', label: 'TunaOS', link: {type: 'doc', id: 'tunaos/index'}, items: ['tunaos/ROADMAP', 'tunaos/CONTRIBUTING', 'tunaos/SECURITY', {type: 'category', label: 'Developer Guide', collapsible: true, collapsed: true, items: ['tunaos/introduction', 'tunaos/building', 'tunaos/bootc-usage', 'tunaos/live-iso-generation', 'tunaos/ci-cd', 'tunaos/troubleshooting']}]},
