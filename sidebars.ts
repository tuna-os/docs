  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'category', label: 'Reference docs', collapsed: true, items: ['albacore', 'yellowfin', 'bonito', 'skipjack', 'grouper', 'gurnard/pantheon-shortcuts', 'marlin', 'gurnard-pantheon']},
    ...
    },
    {
      ...
      items: [
        ...
        'tunaos/hacktoberfest-2026',
        {
          ...
          collapsible: true,
          collapsed: true,
          items: ['tunaos/introduction', 'tunaos/building', 'tunaos/ai-ml-development', 'tunaos/evaluating-in-a-vm', 'tunaos/bootc-usage', 'tunaos/cosmic-desktop', 'tunaos/homebrew', 'tunaos/platform-engineering', 'tunaos/live-iso-generation', 'tunaos/installer-walkthrough/index', 'tunaos/ci-cd', 'tunaos/troubleshooting'],
        },
      ],
    },
    {
