...
[docs/dashboard.md](https://github.com/tuna-os/spindle/blob/main/docs/dashboard.md), which is generated from the router by
...
- Milestone status: [docs/dashboard.md](https://github.com/tuna-os/spindle/blob/main/docs/dashboard.md) (generated, drift-gated)
- Milestone scope and sequencing: [#4](https://github.com/tuna-os/spindle/issues/4)
- The design the code is held against: [SPEC.md](https://github.com/tuna-os/spindle/blob/main/SPEC.md)
- What is inherited, what is ours, what is deferred: [docs/divergence.md](https://github.com/tuna-os/spindle/blob/main/docs/divergence.md)
...
| Storage format identity | A storage-format version distinct from the binary version, with the already-broken transition recorded as a numbered format change in [docs/lifecycle.md](https://github.com/tuna-os/spindle/blob/main/docs/lifecycle.md) |
...
Build and test commands are in the [README](https://github.com/tuna-os/spindle/blob/main/README.md#building-and-contributing);
...
in [SPEC §21](https://github.com/tuna-os/spindle/blob/main/SPEC.md), and the metric the architecture is falsified by — the
fork-case counter — is exported and documented in [docs/metrics.md](https://github.com/tuna-os/spindle/blob/main/docs/metrics.md).
