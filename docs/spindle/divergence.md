...
performance claim in [SPEC](https://github.com/tuna-os/spindle/blob/main/SPEC.md) comes from.
...
Note that [`docs/benchmarks.md`](https://github.com/tuna-os/spindle/blob/main/docs/benchmarks.md) found the `im` crate *faster*
...
- **Interop as a separate report-only board**, diffed against the homogeneous
  ...
  [`conformance-testing.md`](https://github.com/tuna-os/spindle/blob/main/docs/conformance-testing.md) §5.1.
