...
[`spindle.example.toml`](https://github.com/tuna-os/spindle/blob/main/spindle.example.toml) documents every setting, and a
...
[docs/lifecycle.md](https://github.com/tuna-os/spindle/blob/main/docs/lifecycle.md).
...
**Losses are published next to wins.** [docs/benchmarks.md](https://github.com/tuna-os/spindle/blob/main/docs/benchmarks.md)
...
[recorded as a non-result](https://github.com/tuna-os/spindle/blob/main/docs/benchmarks.md).
...
[SPEC §21](https://github.com/tuna-os/spindle/blob/main/SPEC.md).
...
| | |
|---|---|
| [**SPEC.md**](https://github.com/tuna-os/spindle/blob/main/SPEC.md) | The design the code is held against — the log, state without state resolution, authorization, fork handling, trust model, concurrency, performance model, risks |
| [docs/benchmarks.md](https://github.com/tuna-os/spindle/blob/main/docs/benchmarks.md) | Method, every measurement, and the retractions |
| [docs/divergence.md](https://github.com/tuna-os/spindle/blob/main/docs/divergence.md) | The seam: what is inherited from Matrix, ruma and Complement; what is genuinely ours; what is deliberately deferred |
| [docs/conformance-testing.md](https://github.com/tuna-os/spindle/blob/main/docs/conformance-testing.md) | How interoperability is proven |
| [docs/delegated-auth.md](https://github.com/tuna-os/spindle/blob/main/docs/delegated-auth.md) | MSC3861, both ways — built-in provider or a real MAS |
| [docs/metrics.md](https://github.com/tuna-os/spindle/blob/main/docs/metrics.md) | What is exported, including the number the architecture is falsified by |
...
Dual-licensed under **[MIT](https://github.com/tuna-os/spindle/blob/main/LICENSE-MIT) OR [Apache-2.0](https://github.com/tuna-os/spindle/blob/main/LICENSE-APACHE)**, at
your option; contributions are accepted under the same terms.
[`LICENSING.md`](https://github.com/tuna-os/spindle/blob/main/LICENSING.md) records what was checked before choosing, why
