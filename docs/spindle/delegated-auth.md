...
binary — is [evidence/m4-delegated-auth.md](https://github.com/tuna-os/spindle/blob/main/docs/evidence/m4-delegated-auth.md).
...
[evidence/builtin-oidc.md](https://github.com/tuna-os/spindle/blob/main/docs/evidence/builtin-oidc.md).
