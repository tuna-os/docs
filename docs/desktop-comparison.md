...
| **Niri** | Keyboard-driven, scrollable tiling for people who prefer layouts over overlapping windows. | ~0.4–0.6 GB | Efficient on modest systems; best with a Wayland-compatible GPU and a keyboard-centric workflow. | Standard TunaOS flavor on supported bases; availability varies by base. |
