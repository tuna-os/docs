...
Live ISO installer for [Tromsø KDE Linux](https://github.com/tuna-os/tromso) — a KDE Plasma 6 desktop built on freedesktop-sdk with bootc-powered atomic updates.
