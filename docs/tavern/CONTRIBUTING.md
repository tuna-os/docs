...
When adding a new page, follow the eight-step checklist in [CLAUDE.md](CLAUDE.md#adding-a-new-page) — it covers Blueprint, Python, window wiring, gresource registration, and meson sources.
