...
consent tiers of [SPEC §4.6](https://github.com/tuna-os/wootc/blob/main/docs/SPEC.md#46-device-and-connectivity-migration):
...
([branding-and-distribution.md](https://github.com/tuna-os/wootc/blob/main/docs/branding-and-distribution.md)).
...
- **Failures are load-bearing.** The E2E harness records every failed check
  ...
  its own log ([status.md](https://github.com/tuna-os/wootc/blob/main/docs/status.md) tells that story).
...
is defined in the [ROADMAP](https://github.com/tuna-os/wootc/blob/main/ROADMAP.md).
