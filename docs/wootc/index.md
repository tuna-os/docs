...
See [docs/SPEC.md](https://github.com/tuna-os/wootc/blob/main/docs/SPEC.md) for the full specification and section numbers.
...
Follow the verification ladder in [docs/milestones.md](https://github.com/tuna-os/wootc/blob/main/docs/milestones.md).
...
[docs/architecture-boundary.md](https://github.com/tuna-os/wootc/blob/main/docs/architecture-boundary.md); `deploy.sh`
...
- [docs/SPEC.md](https://github.com/tuna-os/wootc/blob/main/docs/SPEC.md) — the full specification
- [docs/architecture-boundary.md](https://github.com/tuna-os/wootc/blob/main/docs/architecture-boundary.md) — the bootc / generic seam
- [docs/milestones.md](https://github.com/tuna-os/wootc/blob/main/docs/milestones.md) — the verification ladder
- [docs/gui-walkthrough.md](https://github.com/tuna-os/wootc/blob/main/docs/gui-walkthrough.md) — installer screenshots
- [docs/non-bootc-adoption.md](https://github.com/tuna-os/wootc/blob/main/docs/non-bootc-adoption.md) — "what if I don't want bootc?"
- [CONTEXT.md](https://github.com/tuna-os/wootc/blob/main/CONTEXT.md) — project vocabulary

## License

The Windows installer components derived from [WubiUEFI](https://github.com/hakuna-m/wubiuefi)
are **GPL-2.0** ([LICENSE-GPL-2.0](https://github.com/tuna-os/wootc/blob/main/LICENSE-GPL-2.0)); the deployer initramfs
and GRUB configuration are **MIT** ([LICENSE-MIT](https://github.com/tuna-os/wootc/blob/main/LICENSE-MIT)).
...
[docs/SPEC.md](https://github.com/tuna-os/wootc/blob/main/docs/SPEC.md#7-license) for details.
