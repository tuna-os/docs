...
> **[Getting started](https://github.com/tuna-os/wootc/blob/main/docs/getting-started.md)** walks through both screens;
> the **[user guide](https://github.com/tuna-os/wootc/blob/main/docs/user-guide.md)** covers everything after, including
> [putting everything back](https://github.com/tuna-os/wootc/blob/main/docs/user-guide.md#9-uninstall--put-everything-back).
> Trying it on your own hardware? Read
> **[manual testing](https://github.com/tuna-os/wootc/blob/main/docs/manual-testing.md)** first.
...
encryption modes — lives in **[docs/status.md](https://github.com/tuna-os/wootc/blob/main/docs/status.md)**. The project
is in **alpha** on the road to a checkable 1.0: see the
**[ROADMAP](https://github.com/tuna-os/wootc/blob/main/ROADMAP.md)** for the version ladder and its evidence gates, and
**[docs/philosophy.md](https://github.com/tuna-os/wootc/blob/main/docs/philosophy.md)** for the thinking behind it all.

## Documentation

| | |
|---|---|
| [Getting started](https://github.com/tuna-os/wootc/blob/main/docs/getting-started.md) | download → first boot, screen by screen |
| [User guide](https://github.com/tuna-os/wootc/blob/main/docs/user-guide.md) | living in the migrated system, and the way back |
| [Philosophy](https://github.com/tuna-os/wootc/blob/main/docs/philosophy.md) | the North Star, the Wubi heritage, why a file |
| [Status](https://github.com/tuna-os/wootc/blob/main/docs/status.md) | the proven matrix and its evidence |
| [SPEC](https://github.com/tuna-os/wootc/blob/main/docs/SPEC.md) | the full specification |
| [Architecture boundary](https://github.com/tuna-os/wootc/blob/main/docs/architecture-boundary.md) | the generic-migration / bootc seam |
| [NTFS on Linux](https://github.com/tuna-os/wootc/blob/main/docs/ntfs-on-linux.md) | the known hazards, and why the design survives them |
| [Borrowed from Libertix](https://github.com/tuna-os/wootc/blob/main/docs/borrowed-from-libertix.md) | six boot-chain and recovery designs, specified against wootc's code, with task lists |
| [WinUI 3 shell](https://github.com/tuna-os/wootc/blob/main/docs/winui-shell.md) | the native Windows shell that replaces Wails: architecture, engine protocol, cut-over |
| [Branding & distribution](https://github.com/tuna-os/wootc/blob/main/docs/branding-and-distribution.md) | one engine, five installers |
| [Manual testing](https://github.com/tuna-os/wootc/blob/main/docs/manual-testing.md) | pre-flight for real-hardware runs |
...
See **[CONTRIBUTING.md](https://github.com/tuna-os/wootc/blob/main/CONTRIBUTING.md)** — the best first contributions
...
([LICENSE-GPL-2.0](https://github.com/tuna-os/wootc/blob/main/LICENSE-GPL-2.0)); the deployer initramfs and GRUB
configuration are **MIT** ([LICENSE-MIT](https://github.com/tuna-os/wootc/blob/main/LICENSE-MIT)). fisherman, bootc,
