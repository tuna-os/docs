...
> Read [architecture-boundary.md](https://github.com/tuna-os/wootc/blob/main/docs/architecture-boundary.md) first — it
...
point `images.json` at your registry (see [branding.md](https://github.com/tuna-os/wootc/blob/main/docs/branding.md)) and
