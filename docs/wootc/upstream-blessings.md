...
([branding-and-distribution.md §2](https://github.com/tuna-os/wootc/blob/main/docs/branding-and-distribution.md)). That is a
...
[`app/branding/README.md`](https://github.com/tuna-os/wootc/blob/main/app/branding/README.md). They are not
...
1. **The branded walkthrough.** Their build's four screens, generated from
   their own assets: [branded-walkthroughs.md](https://github.com/tuna-os/wootc/blob/main/docs/branded-walkthroughs.md).
...
2. **The provenance record.** Where each asset came from, in their own
   published branding: [`app/branding/README.md`](https://github.com/tuna-os/wootc/blob/main/app/branding/README.md)
...
3. **A live E2E video** of that image actually installing, migrating and
   returning to Windows: [https://tuna-os.github.io/wootc/e2e/latest/](https://tuna-os.github.io/wootc/e2e/latest/).
...
[`packaging/winget/README.md`](https://github.com/tuna-os/wootc/blob/main/packaging/winget/README.md).
