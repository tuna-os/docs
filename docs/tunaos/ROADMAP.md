...
| Issue triage policy (queue actionability) | strategist | #1195 — [TRIAGE-POLICY.md](https://github.com/tuna-os/tunaOS/blob/main/TRIAGE-POLICY.md) drafted 08-13: milestone-only roadmap signal, verify-before-trust closure, tiered SLA |
...
| Variant lifecycle policy (admission + Beta→Stable exit criteria) | strategist | #1196, #1175 — [VARIANT-LIFECYCLE.md](https://github.com/tuna-os/tunaOS/blob/main/VARIANT-LIFECYCLE.md) |
