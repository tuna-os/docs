...
| Fedora 45 base readiness | ci-maintainer | #1171 — [FEDORA-BASE-POLICY.md](https://github.com/tuna-os/tunaOS/blob/main/FEDORA-BASE-POLICY.md) drafted 08-13: N+rawhide model, Fedora 45 planning sequenced after Bonito (#272) GA, not parallel |
