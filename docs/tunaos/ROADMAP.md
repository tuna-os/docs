...
by [VARIANT-LIFECYCLE.md](https://github.com/tuna-os/tunaOS/blob/main/VARIANT-LIFECYCLE.md). A passing GNOME/default cell
...
- 🟡 **Per-repo ROADMAP coverage — 16 of 37 active repos (43%)**, measured 2026-08-14 by [`scripts/gen-roadmap-coverage.py`](https://github.com/tuna-os/tunaOS/blob/main/scripts/gen-roadmap-coverage.py).
...
regenerated by [`scripts/gen-roadmap-coverage.py`](https://github.com/tuna-os/tunaOS/blob/main/scripts/gen-roadmap-coverage.py)
...
| Branch protection + required CI | strategist | CI health, #1167 — audited 2026-08-13: [BRANCH-PROTECTION.md](https://github.com/tuna-os/tunaOS/blob/main/docs/BRANCH-PROTECTION.md), active `main` ruleset has no required-status-checks rule; proposed list is `lint`, `lint-summary`, `unit-tests` |
...
| Community governance model | strategist | #1168 — [docs/GOVERNANCE.md](https://github.com/tuna-os/tunaOS/blob/main/docs/GOVERNANCE.md) |
| **Flavor equality mandate** | strategist | #1315, #1316 (cadence parity #1254) |
| **tromso first stable release** | ci-maintainer | tromso#83 |
| Issue triage policy (queue actionability) | strategist | #1195 — ✅ Done ([TRIAGE-POLICY.md](https://github.com/tuna-os/tunaOS/blob/main/TRIAGE-POLICY.md) adopted: milestone-only roadmap signal, verify-before-trust closure, tiered SLA) |
...
| Fedora 45 base readiness | ci-maintainer | #1171 — [FEDORA-BASE-POLICY.md](https://github.com/tuna-os/tunaOS/blob/main/FEDORA-BASE-POLICY.md) adopted 08-13: N+rawhide model, Fedora 45 planning sequenced after Bonito (#272) GA, not parallel |
...
| Variant lifecycle policy (admission + Beta→Stable exit criteria) | strategist | #1196, #1175, #1270, #1254, #1294 — [VARIANT-LIFECYCLE.md](https://github.com/tuna-os/tunaOS/blob/main/VARIANT-LIFECYCLE.md) |
