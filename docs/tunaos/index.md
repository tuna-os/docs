...
[![Adoption evidence](https://img.shields.io/badge/adoption-0_production%2C_2_evaluation-2ea44f?style=for-the-badge)](https://github.com/tuna-os/tunaOS/blob/main/ADOPTERS.md)
...
> [!NOTE]
> **Redfin (RHEL 10)** is local-build only due to EULA restrictions. To build it locally, run `just build redfin <desktop>` (see [rhel-setup.md](https://github.com/tuna-os/tunaOS/blob/main/docs/rhel-setup.md)).
...
> **Apple Silicon status.** [ROADMAP.md](https://github.com/tuna-os/tunaOS/blob/main/ROADMAP.md) is the canonical source
...
Contributions welcome! See [`CONTRIBUTING.md`](https://github.com/tuna-os/tunaOS/blob/main/CONTRIBUTING.md) for:
...
- [Build Pipeline Reference](https://github.com/tuna-os/tunaOS/blob/main/docs/PIPELINE.md) — the build matrix, verification gates, and publish flow in detail
...
- [Disk Encryption & TPM2](https://github.com/tuna-os/tunaOS/blob/main/docs/LUKS-TPM.md) — LUKS2 passphrase setup and TPM2 auto-unlock
- [CI/CD Spec](https://github.com/tuna-os/tunaOS/blob/main/docs/CI_SPEC.md) — target/aspirational workflow spec; see Build Pipeline above for what's actually deployed
- [CI Troubleshooting Playbook](https://github.com/tuna-os/tunaOS/blob/main/docs/ci-troubleshooting.md) — quick reference for diagnosing recurring CI failures
...
- [Issue Triage Policy](https://github.com/tuna-os/tunaOS/blob/main/TRIAGE-POLICY.md) — triage states and SLAs (draft, #1195)
- [Fedora Base Currency Policy](https://github.com/tuna-os/tunaOS/blob/main/FEDORA-BASE-POLICY.md) — adopted N+rawhide sequencing for Fedora-based variants (#1171)
...
- [Branch Protection](https://github.com/tuna-os/tunaOS/blob/main/docs/BRANCH-PROTECTION.md) — rulesets and required CI audit (#1167)
- [Branch Hygiene](https://github.com/tuna-os/tunaOS/blob/main/docs/BRANCH-HYGIENE.md) — branch lifecycle, naming rules, and stale branch triage (#1530)
- [Q3 Checkpoint Policy](https://github.com/tuna-os/tunaOS/blob/main/docs/Q3_CHECKPOINT-2026-08-22.md) — decision integrity and merge-eligible scoring rule (#1683)
