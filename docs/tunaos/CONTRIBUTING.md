...
See [`docs/AGENT_GUIDE.md`](https://github.com/tuna-os/tunaOS/blob/main/docs/AGENT_GUIDE.md) for a detailed architecture overview:
...
- [Agent Guide](https://github.com/tuna-os/tunaOS/blob/main/docs/AGENT_GUIDE.md) — complete reference for contributors
- [Build Pipeline](https://github.com/tuna-os/tunaOS/blob/main/docs/build-pipeline.md) — CI/CD overview
- [Improvement Plan](https://github.com/tuna-os/tunaOS/blob/main/docs/IMPROVEMENT_PLAN.md) — roadmap and progress
- [Testing Guide](https://github.com/tuna-os/tunaOS/blob/main/docs/TESTING.md) — ISO e2e test harness
