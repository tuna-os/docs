...
- **greenboot** — [https://github.com/fedora-iot/greenboot](https://github.com/fedora-iot/greenboot) and the Rust
  rewrite [https://github.com/fedora-iot/greenboot-rs](https://github.com/fedora-iot/greenboot-rs) (Fedora 43 change:
  ...
  *For #22/#26: instead of inventing our own post-migration health gating,
  ...
  [https://developers.redhat.com/articles/2024/08/12/greenboot-automate-rollbacks-atomically-updated-systems](https://developers.redhat.com/articles/2024/08/12/greenboot-automate-rollbacks-atomically-updated-systems)

## M2 — Bootloader migration (#65)

- **bootupd** — [https://github.com/coreos/bootupd](https://github.com/coreos/bootupd). bootc's bootloader
...
- **Fedora bootloader phases** —
  [https://fedoraproject.org/wiki/Changes/BootLoaderUpdatesPhase1](https://fedoraproject.org/wiki/Changes/BootLoaderUpdatesPhase1) (static
...
- **openSUSE sdbootutil** —
  [https://en.opensuse.org/Systemd-boot](https://en.opensuse.org/Systemd-boot),
  [https://microos.opensuse.org/blog/2023-12-20-sdboot-fde/](https://microos.opensuse.org/blog/2023-12-20-sdboot-fde/). The most
  ...
  default** ([https://news.opensuse.org/2025/11/13/tw-grub2-bls/](https://news.opensuse.org/2025/11/13/tw-grub2-bls/)) — a
...
- **bootc composefs-native tracking issue** —
  [https://github.com/bootc-dev/bootc/issues/1190](https://github.com/bootc-dev/bootc/issues/1190) — THE upstream thread
  to watch for CLI/format changes (the #72 drift came from this work).
- **bootc composefs backend docs** —
  [https://bootc.dev/bootc/experimental-composefs.html](https://bootc.dev/bootc/experimental-composefs.html) — states the
...
- **Image sealing with composefs** (Scrivano, 2026-06) —
  [https://scrivano.org/posts/2026-06-05-sealing-with-composefs/](https://scrivano.org/posts/2026-06-05-sealing-with-composefs/) — the
...
- **Ubuntu bootc experiment** —
  [https://github.com/jmarrero/ubuntu-bootc](https://github.com/jmarrero/ubuntu-bootc) — two live landmines we will
...
- **containers/storage composefs end-state** —
  [https://github.com/containers/storage/issues/2095](https://github.com/containers/storage/issues/2095) — where podman's
...
- **rpm-ostree rebase semantics** (Universal Blue docs) —
  [https://universal-blue.discourse.group/t/howto-rebase-to-a-ublue-image-from-fedora/6784](https://universal-blue.discourse.group/t/howto-rebase-to-a-ublue-image-from-fedora/6784),
  [https://docs.projectbluefin.io/administration/](https://docs.projectbluefin.io/administration/) — the
...
- **Vanilla OS ABRoot** — [https://github.com/Vanilla-OS/ABRoot](https://github.com/Vanilla-OS/ABRoot) — the
...
- **Mending Wall** — [https://github.com/lawmurray/mendingwall](https://github.com/lawmurray/mendingwall)
  ([https://flathub.org/en/apps/org.indii.mendingwall](https://flathub.org/en/apps/org.indii.mendingwall)) — per-DE settings
...
- **aurorafin-config-mover** —
  [https://github.com/dtg01100/aurorafin-config-mover](https://github.com/dtg01100/aurorafin-config-mover) — three-phase
...
- **Linux Desktop Migration Tool** —
  [https://codeberg.org/sesivany/linux-desktop-migration-tool](https://codeberg.org/sesivany/linux-desktop-migration-tool) — category
...
| What | Where | Why |
|---|---|---|
| bootc releases | [https://github.com/bootc-dev/bootc/releases/](https://github.com/bootc-dev/bootc/releases/) | cfs CLI drift arrives here first |
| composefs-native tracking | [https://github.com/bootc-dev/bootc/issues/1190](https://github.com/bootc-dev/bootc/issues/1190) | format/CLI direction |
| composefs-rs releases | crates.io `composefs`/`composefs-oci` | NativeStore dependency floor |
| ostree composefs tracking | [https://github.com/ostreedev/ostree/issues/2867](https://github.com/ostreedev/ostree/issues/2867) | legacy-side integration |
| greenboot-rs | [https://github.com/fedora-iot/greenboot-rs](https://github.com/fedora-iot/greenboot-rs) | health-check contract for #22/#26 |
| sdbootutil news | [https://news.opensuse.org/tag/sdbootutil/](https://news.opensuse.org/tag/sdbootutil/) | sd-boot/FDE migration practice |
