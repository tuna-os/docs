...
it, please check out our ["Developing Ghostty"](https://github.com/tuna-os/blueshell/blob/ptyxis-port/HACKING.md) document as well.
...
that understanding. Be sure to read the [AI Usage Policy](https://github.com/tuna-os/blueshell/blob/ptyxis-port/AI_POLICY.md).

## AI Usage

The Ghostty project has strict rules for AI usage. Please see
the [AI Usage Policy](https://github.com/tuna-os/blueshell/blob/ptyxis-port/AI_POLICY.md). **This is very important.**
...
automatically added to the [list of vouched users](https://github.com/tuna-os/blueshell/blob/ptyxis-port/.github/VOUCHED.td). You will need to follow the same
...
We have written a [Translator's Guide](https://github.com/tuna-os/blueshell/blob/ptyxis-port/po/README_TRANSLATORS.md) for
...
our [Style Guide](https://github.com/tuna-os/blueshell/blob/ptyxis-port/po/README_TRANSLATORS.md#style-guide) is followed before
submission.
