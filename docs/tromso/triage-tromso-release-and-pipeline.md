---
sidebar_position: 8
title: "triage tromso release and pipeline"
---
...
- **Evaluation Decision**: Recorded in [ADR 0003](https://github.com/tuna-os/tromso/blob/main/docs/adr/0003-kde-buildstream-upstream-watch.md). Maintained as a watch item because upstream remains in early development, lacks the full Plasma element dependency set (~140+ elements), and continues to depend on mkosi for ISO assembly.
- **Re-evaluation Gates**:
