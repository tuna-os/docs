...
2. Read the [project README](https://github.com/tuna-os/tromso/blob/main/README.md) and
   [CI and ISO pipeline guide](https://github.com/tuna-os/tromso/blob/main/docs/ci-and-iso-pipeline.md).
